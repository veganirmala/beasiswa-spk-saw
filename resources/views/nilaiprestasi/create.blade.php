    ...
    <section class="content">
        ...
        <form action="/nilaiprestasi/create" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="skor" class="form-control @error ('skor') is-invalid @enderror" id="skor" placeholder="Skor" required value="{{ old('skor') }}">   
                @error ('skor') 
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="total" class="form-control @error ('total') is-invalid @enderror" id="total" placeholder="Total" required value="{{ old('total') }}">   
                @error ('total') 
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
