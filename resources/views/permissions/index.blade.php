        ...
        <div class="container-fluid">
            <div class="col-12">
                <div class="card">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <a href="/permission/create" class="btn btn-primary" title="Tambah Data"><i
                                class="fas fa-plus"></i>
                            Tambah</a>
                        <p></p>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <div class="alert alert-danger" role="alert">
                                        Data permission tidak berhasil ditemukan
                                    </div>
                                    <?php endif; ?>
                                    <?php $i = 1; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/permission/{{ $permission->id }}/edit" class="btn btn-danger"
