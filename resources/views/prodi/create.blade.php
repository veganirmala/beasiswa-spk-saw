    ...
    <section class="content">
        ...
        <form action="/prodi/create" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="namaprodi" class="form-control @error ('namaprodi') is-invalid @enderror" id="namaprodi" placeholder="Nama Prodi" required autofocus value="{{ old('namaprodi') }}">   
                @error ('namaprodi') 
