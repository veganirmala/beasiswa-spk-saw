    ...
    <section class="content">
        ...
        <form action="/jenisprestasi/{{ $jenisprestasi->id }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control @error ('tingkat') is-invalid @enderror" tabindex="-1" aria-hidden="true" name="tingkat" id="tingkat" value="{{ old('tingkat')}}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nilai" class="form-control @error ('nilai') is-invalid @enderror" id="nilai" placeholder="Nilai" required value="{{ old('nilai', $jenisprestasi->nilai) }}">   
                @error ('nilai') 
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
