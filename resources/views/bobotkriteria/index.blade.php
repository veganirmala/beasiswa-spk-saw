      ...
      <div class="container-fluid">
        <div class="col-12">
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <a href="/bobotkriteria/create" class="btn btn-primary" title="Tambah Data"><i class="fas fa-plus"></i> Tambah</a>
                <p></p>
                ...
                <?php foreach ($bobotkriteria as $bobotkriteriaa) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="/bobotkriteria/{{ $bobotkriteriaa->id }}/show" class="btn btn-success" title="Detail Data"><i class="fas fa-info-circle"></i></a>
                            <a href="/bobotkriteria/{{ $bobotkriteriaa->id }}/edit" class="btn btn-danger" title="Edit Data"><i class="fas fa-edit"></i></a>
